...
export default function PaymentsError({
  ...
  return (
    <div style={{ padding: "40px 24px", textAlign: "center" }}>
      <h2 style={{ marginBottom: 12 }}>Failed to load the payments ledger</h2>
      <p style={{ color: "var(--portal-muted)", marginBottom: 20 }}>
        Something went wrong while loading this page. No payment was changed. Try again — if it keeps happening, send
