...
export const serviceOptions = freezeCatalog({
  ...
  osha10: { name: "OSHA 10 Training", price: 210, unit: "Person", group: "Training Catalog", desc: "OSHA 10-hour outreach course covering hazard recognition, worker rights, and the Focus Four hazards. Department of Labor cards are issued to each attendee." },
  osha30: { name: "OSHA 30 Training", price: 510, unit: "Person", group: "Training Catalog", desc: "OSHA 30-hour outreach course for supervisors and safety leads, covering hazard control, program administration, and OSHA recordkeeping. Department of Labor cards are issued to each attendee." },
  ...
  fall: { name: "Fall Protection Training", price: 80, unit: "Person", group: "Training Catalog", desc: "Fall hazard recognition, harness inspection and fit, anchorage and connector selection, and rescue planning under 29 C.F.R. Part 1926 Subpart M." },
  ...
  scaffold: { name: "Scaffold User Training", price: 70, unit: "Person", group: "Training Catalog", desc: "Scaffold user awareness covering safe access, guardrail and planking requirements, platform loading, tag systems, and what to report to the competent person." },
  mewp: { name: "MEWP / Aerial Lift Training", price: 105, unit: "Person", group: "Training Catalog", desc: "Operator training for boom and scissor lifts to ANSI A92 standards: pre-use inspection, fall restraint, ground conditions, and safe positioning near hazards." },
  forklift: { name: "Forklift / PIT Training", price: 115, unit: "Person", group: "Training Catalog", desc: "Powered industrial truck operator certification under 29 C.F.R. sec.1910.178, with classroom instruction, hands-on evaluation, and written operator authorization." },
  rigging: { name: "Rigging & Signal Person Training", price: 115, unit: "Person", group: "Training Catalog", desc: "Sling selection and inspection, load weight and center of gravity, hitch configuration, and standard hand and voice signals for crane operations." },
  ...
  confined: { name: "Confined Space Awareness Training", price: 100, unit: "Person", group: "Training Catalog", desc: "Permit and non-permit space identification, atmospheric hazards and monitoring, entry roles, attendant duties, and rescue expectations under 29 C.F.R. sec.1910.146." },
  excavation: { name: "Excavation / Trenching Safety Training", price: 100, unit: "Person", group: "Training Catalog", desc: "Soil classification, protective system selection, spoil placement, access and egress, and daily competent person inspection under 29 C.F.R. Part 1926 Subpart P." },
  loto: { name: "Lockout / Tagout Training", price: 85, unit: "Person", group: "Training Catalog", desc: "Energy isolation procedures, authorized versus affected employee roles, group lockout, shift transfer, and verification of a zero energy state before work begins." },
  ...
  nfpa70e: { name: "NFPA 70E Awareness Training", price: 135, unit: "Person", group: "Training Catalog", desc: "Arc flash risk assessment, incident energy and PPE category tables, equipment labeling requirements, and energized work permit expectations." },
  ...
  respiratory: { name: "Respiratory Protection Training", price: 85, unit: "Person", group: "Training Catalog", desc: "Respirator selection, medical evaluation and fit test requirements, user seal checks, cartridge change schedules, and program administration under 29 C.F.R. sec.1910.134." },
  ...
  firstAid: { name: "First Aid / CPR / AED Training", price: 145, unit: "Person", group: "Training Catalog", desc: "Instructor-led certification course covering adult CPR, AED operation, choking response, bleeding control, and workplace first aid. Certification cards are issued to each attendee." },
  ...
  spotter: { name: "Spotter / Flagger Training", price: 80, unit: "Person", group: "Training Catalog", desc: "Flagger station setup, signaling devices and procedures, work zone traffic control layouts, and communication protocols for spotting equipment." },
